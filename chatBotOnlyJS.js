...
function getTextArea() {
   return $('._1mf._1mj').parents();
}

function clickOnAllParentsElements() {
   let allParentsElements = getTextArea();
   console.log(' allParentsElements', allParentsElements);
    for (let i = 0; i < allParentsElements.length; i++) {
        console.log('allParentsElements[i] ', allParentsElements[i]);
        $(allParentsElements[i]).focus();
    }
}

clickOnAllParentsElements();
